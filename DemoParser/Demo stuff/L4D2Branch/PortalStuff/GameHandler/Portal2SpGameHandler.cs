...
namespace DemoParser.Demo_stuff.L4D2Branch.PortalStuff.GameHandler
{
    internal class Portal2SpGameHandler : OrangeBoxGameHandler
    {
        ...
        private readonly Result.Point3D FINALE_END_POS = new Result.Point3D(54.1f, 159.2f, -201.4f);
        private readonly Result.Point3D INTRO_START_POS = new Result.Point3D(-8709.20f, 1690.07f, 28.00f);
        private readonly Result.Point3D INTRO_START_TOL = new Result.Point3D(0.02f, 0.02f, 0.5f);
        ...
        private bool onTheMoon(Result.Point3D position)
        {
        ...
        private bool atSpawn(Result.Point3D position)
        {
