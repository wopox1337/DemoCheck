...
using System.IO;
using DemoParser.Demo_stuff.L4D2Branch.BitStreamUtil;
using DemoParser.Demo_stuff.L4D2Branch.PortalStuff.Result;

namespace DemoParser.Demo_stuff.L4D2Branch
{
    /// <summary>
    ...
    {
        public CSGODemoInfo.DemoParser CsgoDemoInfo;
    ...
    internal class L4D2BranchParser
    {
        ...
        public static CSGODemoInfo.DemoParser CsgoDemoParser(string file)
        {
            var csgodemo = new CSGODemoInfo.DemoParser(File.OpenRead(file));
