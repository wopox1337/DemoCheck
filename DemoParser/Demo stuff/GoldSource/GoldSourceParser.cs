...
using System.Text;
using DemoParser.Demo_stuff.GoldSource.Verify;
using DemoParser.Demo_stuff.L4D2Branch.PortalStuff.Result;

namespace DemoParser.Demo_stuff.GoldSource
{
    /// <summary>
    ///     Types for HLSOOE
    /// </summary>
    public class Hlsooe
    {
        ...
        public class NetMsgFrame : IFrame
        {
            ...
            public L4D2Branch.PortalStuff.Result.Point3D LocalViewAngles;
            public L4D2Branch.PortalStuff.Result.Point3D LocalViewAngles2;
            public string Msg;
            public int OutgoingSequence;
            public int ReliableSequence;
            public L4D2Branch.PortalStuff.Result.Point3D ViewAngles;
            public L4D2Branch.PortalStuff.Result.Point3D ViewAngles2;
            public L4D2Branch.PortalStuff.Result.Point3D ViewOrigin2;
            public L4D2Branch.PortalStuff.Result.Point3D ViewOrigins;
        }
    ...
    public class GoldSource
    {
        ...
        {
            public float Fov;
            public L4D2Branch.PortalStuff.Result.Point3D Origin;
        ...
        public struct EventFrame : IFrame
        {
            ...
            {
                public L4D2Branch.PortalStuff.Result.Point3D Angles;
                public int Bparam1;
                public int Bparam2;
                public int Ducking;
                ...
                public int Iparam2;
                public L4D2Branch.PortalStuff.Result.Point3D Origin;
                public L4D2Branch.PortalStuff.Result.Point3D Velocity;
            }
        }
        ...
        public struct NetMsgFrame : IFrame
        {
            ...
            public UserCmd UCmd;
            public L4D2Branch.PortalStuff.Result.Point3D View;
            ...
            public override bool Equals(object obj)
            {
                return obj is NetMsgFrame frame &&
                       ...
                       EqualityComparer<L4D2Branch.PortalStuff.Result.Point3D>.Default.Equals(View, frame.View);
            }
            ...
            public struct RefParams
            {
                ...
                public L4D2Branch.PortalStuff.Result.Point3D Crosshairangle;
                public int Demoplayback;
                public L4D2Branch.PortalStuff.Result.Point3D Forward;
                ...
                public L4D2Branch.PortalStuff.Result.Point3D Punchangle;
                public L4D2Branch.PortalStuff.Result.Point3D Right;
                public L4D2Branch.PortalStuff.Result.Point3D Simorg;
                public L4D2Branch.PortalStuff.Result.Point3D Simvel;
                public int Smoothing;
                public int Spectator;
                public float Time;
                public L4D2Branch.PortalStuff.Result.Point3D Up;
                public DPoint3D Viewangles;
                public int Viewentity;
                public L4D2Branch.PortalStuff.Result.Point3D Viewheight;
                public L4D2Branch.PortalStuff.Result.Point3D Vieworg;
                ...
                public override bool Equals(object obj)
                {
                    return obj is RefParams @params &&
                           ...
                           EqualityComparer<L4D2Branch.PortalStuff.Result.Point3D>.Default.Equals(Crosshairangle, @params.Crosshairangle) &&
                           Demoplayback == @params.Demoplayback &&
                           EqualityComparer<L4D2Branch.PortalStuff.Result.Point3D>.Default.Equals(Forward, @params.Forward) &&
                           ...
                           EqualityComparer<L4D2Branch.PortalStuff.Result.Point3D>.Default.Equals(Punchangle, @params.Punchangle) &&
                           EqualityComparer<L4D2Branch.PortalStuff.Result.Point3D>.Default.Equals(Right, @params.Right) &&
                           EqualityComparer<L4D2Branch.PortalStuff.Result.Point3D>.Default.Equals(Simorg, @params.Simorg) &&
                           EqualityComparer<L4D2Branch.PortalStuff.Result.Point3D>.Default.Equals(Simvel, @params.Simvel) &&
                           Smoothing == @params.Smoothing &&
                           Spectator == @params.Spectator &&
                           Time == @params.Time &&
                           EqualityComparer<L4D2Branch.PortalStuff.Result.Point3D>.Default.Equals(Up, @params.Up) &&
                           EqualityComparer<DPoint3D>.Default.Equals(Viewangles, @params.Viewangles) &&
                           Viewentity == @params.Viewentity &&
                           EqualityComparer<L4D2Branch.PortalStuff.Result.Point3D>.Default.Equals(Viewheight, @params.Viewheight) &&
                           EqualityComparer<L4D2Branch.PortalStuff.Result.Point3D>.Default.Equals(Vieworg, @params.Vieworg) &&
            ...
            public struct UserCmd
            {
                ...
                public L4D2Branch.PortalStuff.Result.Point3D ImpactPosition;
                ...
                public override bool Equals(object obj)
                {
                    return obj is UserCmd cmd &&
                           ...
                           EqualityComparer<L4D2Branch.PortalStuff.Result.Point3D>.Default.Equals(ImpactPosition, cmd.ImpactPosition) &&
                           Impulse == cmd.Impulse &&
                                ...
                                switch (currentDemoFrame.Type)
                                {
                                    case Hlsooe.DemoFrameType.StartupPacket:
                                        ...
                                        var g = new Hlsooe.StartupPacketFrame
                                        {
                                            Flags = br.ReadInt32(),
                                            ViewOrigins =
                                                new L4D2Branch.PortalStuff.Result.Point3D(br.ReadSingle(), br.ReadSingle(), br.ReadSingle()),
                                            ViewAngles =
                                                new L4D2Branch.PortalStuff.Result.Point3D(br.ReadSingle(), br.ReadSingle(), br.ReadSingle()),
                                            LocalViewAngles =
                                                new L4D2Branch.PortalStuff.Result.Point3D(br.ReadSingle(), br.ReadSingle(), br.ReadSingle()),
