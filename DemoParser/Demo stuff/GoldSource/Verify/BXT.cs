...
namespace DemoParser.Demo_stuff.GoldSource.Verify
{
    ...
    public static class Bxt
    {
        ...
        {
            public string command;
            public L4D2Branch.PortalStuff.Result.Point3D corner_max;
            public L4D2Branch.PortalStuff.Result.Point3D corner_min;

            public override void Read(BinaryReader br)
            {
                corner_min = new L4D2Branch.PortalStuff.Result.Point3D(br.ReadSingle(), br.ReadSingle(), br.ReadSingle());
                corner_max = new L4D2Branch.PortalStuff.Result.Point3D(br.ReadSingle(), br.ReadSingle(), br.ReadSingle());
                command = new string(br.ReadChars(br.ReadInt32()));
            }
